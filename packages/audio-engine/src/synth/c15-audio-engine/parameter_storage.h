...
using Scale_Aspect =
    Engine::Proto::Scale_Aspect<C15::Properties::SmootherScale>;
using Render_Aspect =
    Engine::Proto::Render_Aspect<C15::Descriptors::SmootherSection,
                                 C15::Descriptors::SmootherClock>;
...
struct Hardware_Source_Parameter : Proto::Parameter {
  C15::Properties::HW_Return_Behavior m_behavior =
      C15::Properties::HW_Return_Behavior::Stay;
  uint32_t m_offset = 0;
  inline bool
  update_behavior(const C15::Properties::HW_Return_Behavior _behavior) {
...
struct Setting_Parameter : Proto::Parameter {
  ...
  float m_scaled = 0.0f;
  inline void init(const C15::Properties::SmootherScale _id,
                   const float _factor, const float _offset,
                   const float _value) {
    m_scaling.m_id = _id;
...
struct Modulateable_Parameter : Proto::Parameter {
  float m_amount = 0.0f, m_base = 0.0f, m_ceil = 0.0f, m_unclipped = 0.0f,
        m_scaled = 0.0f;
  C15::Parameters::Macro_Controls m_source =
  ...
  inline bool modulate(const float _mod) {
    ...
    return m_position != m_unclipped; // basic change detection (position needs
                                      // to be updated from outside)
  }
...
template <class HW, class HA, class MC, class TP, class DP>
...
using Global_Storage = Engine::Storage::Global_Parameter_Storage<
    C15::Parameters::Hardware_Sources, C15::Parameters::Hardware_Amounts,
    C15::Parameters::Macro_Controls, C15::Parameters::Global_Modulateables,
    C15::Parameters::Global_Unmodulateables>;

using Layer_Storage = Engine::Storage::Layer_Parameter_Storage<
    C15::Parameters::Macro_Controls, C15::Parameters::Local_Modulateables,
